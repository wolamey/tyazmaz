  ...
  const fetchUserData = async () => {
    try {
      ...
      const response = await fetch(
        "http://http://192.168.11.131:4545:4545/api/v1/users/me",
        {
          method: "GET",
          headers: {
...
const handleRefactor = async () => {
  ...
  try {
    const response = await axios.post(
      `http://http://192.168.11.131:4545:4545/api/v1/refactor?upload_id=${uploadId}&id_product=${idProduct}&id_parent_ce=${idParentCE}&tm=${tm}&type_operation=${typeOperation}`,
      data,
      {
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `http://http://192.168.11.131:4545:4545/api/v1/upload?user_id=${userId}&id_product=${idProduct}&id_parent_ce=${idParentCE}&tm=${tm}&type_operation=${typeOperation}`,
        formData1,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const fetchUsers = async () => {
    ...
    try {
      ...
      const response = await axios.get(
        "http://http://192.168.11.131:4545:4545/api/v1/users",
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  function updateImageDisplay() {
    ...
    axios
      .post("http://http://192.168.11.131:4545:4545/api/v1/preview", formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleSubmitNewUser = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://http://192.168.11.131:4545:4545/api/v1/register",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const downloadFile = async (uploadId) => {
    ...
    try {
      const response = await axios.get(
        `http://http://192.168.11.131:4545:4545/api/v1/save?upload_id=${uploadId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
